...
<title>Foosher Inc. - <tiles:insertAttribute name="title"/></title>
...
<script type="text/javascript" src="<c:url value="js/all-in-one-min.js"/>"></script>
<script type="text/javascript" src="<c:url value="js/setup.js"/>"></script>
